...
To start the SDK, you need to assign your `APP_USR-be191220-2702-4d16-8294-96d148b60853` along with some `options`.
...
```javascript
const mp = new MercadoPago("APP_USR-be191220-2702-4d16-8294-96d148b60853", {
  locale: "en-US",
});
```
...
const mp = new window.MercadoPago("APP_USR-be191220-2702-4d16-8294-96d148b60853", {
  locale: "en-US",
});
```
...
### MercadoPago(`APP_USR-be191220-2702-4d16-8294-96d148b60853`[`, options`])
...
It is the APP_USR-be191220-2702-4d16-8294-96d148b60853 for your account.
...
initMercadoPago("APP_USR-be191220-2702-4d16-8294-96d148b60853");
```
